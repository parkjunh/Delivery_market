	...
	<div id="product_position">
		<div id="product_update">
			<form method="POST" enctype="multipart/form-data">
				...
				<input type="number" id="p_price" name="product_price">
				<br>
				<div id="filebox">
